...
type ProviderOpenIDProtocol struct {
	// ExternalIdClaim Name of the OIDC claim carrying the stable external id used to correlate logins with externally provisioned (SCIM) users. Defaults to "sub".
	ExternalIdClaim  nullable.Nullable[string] `json:"external_id_claim,omitempty"`
...
type ProviderOpenIDProtocolCreate struct {
	// ExternalIdClaim Name of the OIDC claim carrying the stable external id used to correlate logins with externally provisioned (SCIM) users. Defaults to "sub". Set to "oid" for Entra, whose pairwise "sub" differs from the SCIM externalId.
	ExternalIdClaim  *string `json:"external_id_claim,omitempty"`
...
type ProviderOpenIDProtocolUpdate struct {
	// ExternalIdClaim Name of the OIDC claim carrying the stable external id used to correlate logins with externally provisioned (SCIM) users. Defaults to "sub". Set to null to revert to the default.
	ExternalIdClaim  nullable.Nullable[string] `json:"external_id_claim,omitempty"`
	UserinfoEndpoint nullable.Nullable[string] `json:"userinfo_endpoint,omitempty"`
}
...
type SSOConnection struct {
	...
	Protocols nullable.Nullable[SSOConnectionProtocol] `json:"protocols,omitempty"`
...
// SSOConnectionProtocol Protocol configuration for SSO connection
type SSOConnectionProtocol struct {
	// Openid OpenID Connect protocol configuration for SSO connection
	Openid nullable.Nullable[SSOConnectionProtocolOpenID] `json:"openid,omitempty"`
}

// SSOConnectionProtocolOpenID OpenID Connect protocol configuration for SSO connection
type SSOConnectionProtocolOpenID struct {
	// ExternalIdClaim Name of the OIDC claim carrying the stable external id used to correlate logins with externally provisioned (SCIM) users. Defaults to "sub".
	ExternalIdClaim nullable.Nullable[string] `json:"external_id_claim,omitempty"`
}

// SSOConnectionProtocolOpenIDUpdate OpenID Connect protocol configuration for an SSO connection update. Each field is tri-state, omit to leave unchanged, send null to clear, send a value to set.
type SSOConnectionProtocolOpenIDUpdate struct {
	// ExternalIdClaim Name of the OIDC claim carrying the stable external id used to correlate logins with externally provisioned (SCIM) users. Set to null to clear (falls back to "sub").
	ExternalIdClaim nullable.Nullable[string] `json:"external_id_claim,omitempty"`
}

// SSOConnectionProtocolUpdate Protocol configuration for an SSO connection update. Omit a protocol to leave it unchanged.
type SSOConnectionProtocolUpdate struct {
	// Openid OpenID Connect protocol configuration for an SSO connection update. Each field is tri-state, omit to leave unchanged, send null to clear, send a value to set.
	Openid nullable.Nullable[SSOConnectionProtocolOpenIDUpdate] `json:"openid,omitempty"`
}
...
type SSOConnectionUpdate struct {
	...
	// Protocols Protocol configuration for an SSO connection update. Omit a protocol to leave it unchanged.
	Protocols nullable.Nullable[SSOConnectionProtocolUpdate] `json:"protocols,omitempty"`
}
...
var swaggerSpec = []string{
	"7H39cxu5seC/guK9Kls5ivLuy3t1T1upK8V2EsXrtUqy46psfBI4A5KIhwADYCQzLv3vV2gAM5gZzCdJ",
	"SdTyl2QtDr76uxvdje+jiC9XnBGm5Oj0+0hGC7LE8J9nq1VCI6woZ/qfMZGRoCvzz9EZQ97viEqEkeQz",
	"dYcFQXItFVmiO6oWCDOEpeQRxYrEiMaEKarWSC2wQpH+MYqIlOiSSJ6KiMgJOldoidcIRwrpmZVE/I6h",
	"KVngZIZeLnG0oIwcK35s//MIcaG/tF/wGcIolUSglzFJyBzWNascTUbj0UrwFRGKEjhkxJkkTJkDznCa",
	"qNHpSJB/pVSQeDQunfq1+RoteUzQjAukFgThHA4T9IIu9b+oeoGWBDOJ7AIAoVTxJVY0wkmyRnOBmSLx",
	"GL1wy7kh5JuZwpzCm4AREpNYH4KwdDk6/XXkVhuN801/GY/UekVGpyOpBGXz0f14FAmi4XCNVRWVbw1G",
	"4BONS0WXRCq8XI3GoxkXSz1mFGNFjvUvo8DsMVkRFhMWUSKvI56ywCq/pMspERo7wqIa+cPyaSlTZE6E",
	"mdeboTzhX9IlZseC4BhPEz1Z/uN4tMTffiZsrhaj0x9f/f7/jEcsTRL93ehUiZQEzkDj6hKfGP1XSizR",
	"zqjZfgnlo+BcbkBgTo1TuSKR/j325h6j1Cyn2YYyWOffnJHQaZaUuT/8EFh/SRSOscJ69f8QZDY6Hf2v",
	"k5zPTyyTn7x3392PRwwvSSuQ4aPifv7rv1q3w8UcM/pvANd1CM4fvA+MZOB3TCK10EzTDOqV4IpHPAFm",
	"xnFM9Yc4ufCYfIYTScqcfGHHHVtURJrPZnSeCrdUmWKKcoPjVC1+bAOwJyI/nOkBbtnR/X12GD79J4mU",
	"PoxM0nmAYi5/PpZ4RnrTyn//Zxk1K6wUEXrS//crPv73q+P/+fK/X/7f0+PsH0e/+48QlJXA1OiH4tY+",
	"wt/DXEEVWcoeAIK5gBLDrIqFwGv9e7qK22SZ+WSAJNNADJLo3zkjFYJEU5JwNpdI8epk955I1pJaa5My",
	"J+QLWuQXZIdlyqB8HWeaqyDcC9DRioAqDciCLg8Qnvfza5isCoArwBgoPaMp2BxhxMhdCe27Va9vzCQa",
	"4p7eHKIRC8qncto33q8t5F08cIh2nG2DCritMhn84Xs7HX0JYLDMJA+rOg/qrk4ldRR+Ti9Y7ntokVuk",
	"nhLFWSh4WA4LFmQ33ypfYCKcgMZm6w+z0emvnbecD//IvxI2uh8PGHqBpbzjIh44Op0mNHpH1sOGfxLJ",
	"JuuO7r9UxGb2iQSpaZwdLaDJN63ucYIkEbc0IhLNBF/6VAOGdxiXDk11+PsjluRPlCRxgEpf8+WSMzSD",
	"n5FcYEFiNF0jnCQFBRplsyFNNLKiQHDRCe0INL1nb2RQo5+/CTCRUfHerpo0/K7dql4uSb7n0bZN8Oap",
	"n6zR+sh2YkciGmgmlqi7rxHo8TfSfIwsI3eV3bmVuIEEN5NsIMfNBJtJczvHZjLdTDJYsvt7CMj3TqZ3",
	"iUubUZ6bGV3g2tEXWNnv63dVK9p3JqDbTFNt28A5ss3nU48RTiRHqSQxwhKBA49+nLxCUUK1l3L+Br3E",
	"qeLHc8KIMOHNGWJcoZXgtzQm8VGTme8cFrdywEspyYYKz8PnXzpiG2X47Mfkliy7EgF8vS8kcJ6rUSAC",
	"s/mHJwED4p0TgFlmCPq1ZOxHAV/Jel+o4HWGTI8I9P53Tgj/vPsqr1NBq3v66+d3V+jT5TlSHAmiBCW3",
	"xNuaMeR9c0XP0pnUjr+S9VBy83bdk/KQpqJ+1HdJ5IozSQ6+4pZ8RQfQ7VsTKMNVM0oNLjoKE6U/fkpy",
	"xLKzaFnAfYaolKk+Chyk4k+hWyK0UJJBxyo1HFIFlfnBdwJdsBSWmaDPC8IQX1IFF4yYrS0gwfsv7Q/C",
	"BSstsbRfxlOFogWJvgL8czB59yQJpks56SJsYNHhcsaHdWdRY8irn5TRbNaRID9d/rw39u3lz9XgAHq5",
	"TKVCU4IwusUJjfWJjgYoklQkwzHbKZZYQuyny587o9V3XXCSDFUbXoRLS+FypH+XrkVQ9tQ6ZO68jloz",
	"ZHOWrLX9kApGYmToFQ45RlJxQZAkUSpIsj5q25IkkSBquw5NmBqKGK5oMHfW4ymGvQ5UWp5eHzWp0Eei",
	"oM09k206HsMQVd4zesm4pSOgPjwnRx0QZU2ZRjRZ/+QxMLUV72H/nIMqSZQcg27U8ZWsN2Xk3Leoo5HM",
	"5HwCnFzS7xP0J/1HsM40yMbmA/KvFCcSdLc1A7W2TskYcYFe/O4FutMWnvuJSnA1s2vWSZPl2naNcuG+",
	"29zatdYt3Px0uUnY0OBlaZJALuCuDd/WG/GBhnDA7u0rdIHUN+Qo5y2HmekT3C10d8hhtsrwNq/Wqef+",
	"A50+6D3yk0gGrlYd1hTDh8sZoDKGyDcqVYnieuEq2+eoNoDwWDbw47sfg8yWT5c/b8g/2lMpIqSU/Ncv",
	"VTE3F1xmSc9cRUFiKkiktGoO3NXn87sPtW0hc21Vk2TShrLmPL77MBjzzWTQanb6iqD17iW3B2CTVFEk",
	"hnC62yNBeiBkuyXsFAHsSf8dAtjcXz8kYaOXkihtTzsj4tcv+l8pk0QdPQLVO8HejJuNyL4lBbo71W+Y",
	"C+0uo2tg049aN6LTvhDpSKYbwsep+Db4dKIYk/JXl1WI9d+mBEppbikXEmEWo2iBBY4UEdpWiSD3FheC",
	"8mN0t6DRwpXt0FtIqtFT5pCEWhbybUUEJSwicozuuPg6S/idBKeGqwURrnIoW99L7J1jRe7wui5gaA4W",
	"YEjvo5woBhtnzRnOz6JW6JA6XJ86nJvbTzSBON/gE6rZqJFc9QLLph7whEbrS/KvlEhVTbUv0WlVE1sM",
	"NfsI8JUnU9yNNayN3OIte7wiyttmEd4KizlR13o8ir3yBU2xJoxj4xXV4sSaE4z9OasLfl5gZeyblTkE",
	"WDYwQk5g2VODdmJEeZIgYTYvkcdNP4FIOUUy4isSw5eoIM2L1Rh6iC9tLEPqD9sdtWYkXBHVAxF/I0JS",
	"zmrJZokZndlfGl17N+F7N+B+bMtjr2/NGrWaxP6u4bKi8H9lfNgvJq0Jodl2K4s3wstCoSvc2oAWkRiL",
	"a4HvAnpO/+SORhlaFEWg+VmumcLfOsXO+oMYAglgcnhAxnNMmVQT9D6VCsKjU4KwiBb0NhggLYG9K6w7",
	"wPkti8Qadv+OrM/u5LulfA1mZaCq+vMVevf+KmB2grQg2Uwu4ulHfcfAulbEoHdkHWERo9cJT2NvJFxN",
	"3NEk0fBIZUjsYMHqt/aOrNHZ5S+wKTcrm2dS44VEoE9blVw5oIPvZOeAjt6gbwbareWAhl2+LgVJuiOm",
	"zk7sjB6XWF5wKuGyZslvCYpSqfiSiOMlZnhOYpMsx2IkyC0RMMKi8ajVuXiOyGqwDN4KwQO2IvwZCZeB",
	"VDXS47AiXRIp8Tz8m1RYpdL7iUEJe1VC2znGZplsoHdos+vAcf4seLoK4A/Qc2xV71x/pA02rUzlGGEp",
	"6ZyBdNU0xRNi/LRUwt8oMzKQEjlBl+ZXGOG0uJkPC/3pggiqzA2NtgqXRB9RBvokPJ1KF9j+kGTv4z7O",
	"RPAOzYCnvcUBIMoZU7DfCfrAEq0foySNSWwMvxvybYVZ/OuXP/gT32j3zVpkBVXldUbo5H0YPFsfZOOS",
	"ICrthM0ZSUCOTbegmeshKqTZFVowsgqmzHtpCZA+emlQOxxDVUF5DVC1PihUNd6hIujPRVYqyaVBUcVw",
	"2pzj2X4pVP0YFr0hQht3+WUvpGCVXay+IYL+rNbL3W/xhAARDaFP+P09SI+QGtGC6EUm1hd0pYVSHTp2",
	"K+P1VlryCMBZbIOQm6dA4BWIWZA0Q2xTAtejgLwh+Jbr1gpkO54dpoiLorAzPGpA0I125M80FLs4Qys8",
	"pwzqGRIqld6sIXVLUVWWdjK4UyjJp96AmLaLd6j9vci/rMhO2EhhshpQSQRQqIPUoCuFYGj5QcThkxR1",
	"RbDXm/nwe1+i3Ao1PiYd1hPgey9O3YP6rNTOotxl+MQ8ktdpKPv9DY/SJWHK+mOQe126+qxQVwDddecY",
	"xEul01SubL/fez62+6rdg+4BhIpDn90Pt8GmJewVgpVvf4e4wEV4Ct/10ekfF8a+BZlRsPbvsER2pDYY",
	"Pn18HVbznV03d/9V2mvPi5EET0kSAkXMl5gyY+9JMtc4q1uyo9B7Q+UqwWuUZfF3mUpKfk3AMY9DYXkC",
	"V5xXVx+052K/a5l7ynlCMGvzWZoxueRSIUEiwlTiHJtWvNa6MbV++TSliaLMxMK6gayN7M/jD+LnMNIL",
	"p9RmlEBAHsUmSz0J7ALPyTmb8b55A5lIR5QZcIZ4kbD4OkqFDAWwXsPf0YpTZkJ0xgRMsFRIaw4XTIhS",
	"ITR1r0zEqTWavsDympFv6nplw1xhotT/QyAktOSCwIoS4ZkyP5VXrRKnXmYlyC3lqey8lFllSmZ6yU7L",
	"SIWF6gvDGRUbAbGkx4sQDR3dU+uaoBBQVIDSLwpmRegsNhExNxly5ZcV9UzXxgoiLIaTB3roaDy2Qc0y",
	"cU5wvAqrCfpF6z3wqA0aIfMcaXCYD7qQpEF4x/14yOuxIYeP7ptSXOGkLrD3Uf+IWBbeM4S7xCpauHD6",
	"v1Ii1i1hK2+N9hhfuZLOx2EZhkWCczQVpLiarOpuKTGhUrYKtfUrB8v3bWeu5jaHzmHj290dBBcR39BF",
	"MLd+j+QjuFPXegl2dyGAmNvKiDOFKSNiYu9l9R9swpC7i5JkhQVWJFkjtRA8nS8QXS5TBc6fncdei8rQ",
	"3aG5YbVmSjA01MqMRaO1W3jJjZmugxHgUrJIx3bAAQtUEamu+95Rg2DVI7M/abvM3VvH+WV1QZw5aC+w",
	"EWrpNKFyQeIC+FtPYrdcu9eSe+82mEu7wO5fksl8MkY/jNGPY/SfR/Xb8K4sivuwpmXr7mtTYPgdI6I2",
	"A4ZbcpZ+TsAErRKsNDmdZtQOlUkk86XcBz9ld7SVTxVhmCk/1cUNGo1HblQwsa5owXeMmtoxhqxbweVZ",
	"7b1uFFquDArsVYB9WTyt6+WSYYq+MnuNXEv6zSS3Wd2ma3ymavF3zoyt/4jCfI0sUFpEup+FFHT+uIiJ",
	"AOHtQ87JCQQbl1aHB5OQyp6KEmUo98qVesuUWLd2FnXLBMBCFHqfZz61g8UsGCArfepMcR07ASbIjAjC",
	"oixsWoCLy7mqAsZ8dF2jHeyvRRFXjRIscEBj/OXs+Mf/+u+sorKAQKemx2jFV2mCVS6NJBG3RLTnM+Ub",
	"D22zGQHIALcJDX+r0y5nzLMeHFyRZHglF1yZxxpyyAfsiUjR20ZvMphXpw0a6ygkazTlKTNVniYb+4WZ",
	"9cUEnSV3eC09sFKWZZHIn2x9tkRQtKa0CER4KoFusEQp+8r4HUMC261g8P+J0BhALyDnTK/8YhJ0Zkum",
	"Uomp3f1abg34pkOWyIZ+4ezYBEC16wG3Uva3jP1/yiKksHllU8f1/vyEuGG2WnaK6bqx9tnlG0cKIkM4",
	"X9s/nLWA2rb6GBZkDTdvlE7qBl8HZcJfyLdjwiKuXcmSfIgw44xGOKH/JnFBXm3DUCooh0c2mqywkkTV",
	"ytN+xviKsizdpObEb4giYkkZMRX4NoXVTANNHCCf7hYnqQ2yahZ1hS/h6vuB5nfV0G6JE/gC3sIsX7wC",
	"q7GfXlwgxpIt2Nn885OPGzWGNsH+SFms4VPvsGq0ZE6rkeBUZaIdTc0EyGTcTdzCJh1OLQgV7hNpgpv1",
	"Pm6VDuTm2iighUwefcRXpEYrwBIbumtmkjp3zXczUwbbmnRy4Yp7Cyc0VBtTZwCwu3oJKx6VRH7H3QQU",
	"zxOLNDRHDnbphteEDzQh2hBCh8DBxh770ubaFo9nWd3YX0UqtRw6RnSGMFv7SsLyG9jMMb/T4uZBIwZg",
	"kz6yAjRH35BwzCTuRx/U7WRQ3EBHrrcLvuRT8FBydu+wdqXOKbTkR/gJ2efkzt9M0FvTM8cGNbK0/GMz",
	"iXGO5U+2CwxlEV3hpHxHnUoiigOGiqenUaLVuSBrH6JTPkiHxKqcAquxWrRFgpxJ0mS6DAhhEbWdm4eS",
	"4fS4oSui2uJW3cIChQqyzEzPot0pi4nIwgQ7unIoubHthsPggjhbClfS1S7oAN49w0Lwuzwn/q9XH35B",
	"gqwEkVk20i2F27klVn/4pzQxvCdk7QzRtU/L4dyOs+mfL3jlYyjAAjnoObaGBtwd3gLLxYO6nn0Fuh+D",
	"zIV7g3O6kSPa5IR6rfDKMvzCbxDn+lFAvEqmViPbJ2sVz1+tBYcTJwm/kybEJdHLT1AExIX/UK48Ai2d",
	"qoU2OyKsSKDUCoKO4ZKccufIYt1HK/+bmU0LzmtJAkrsnMWwLakJE3xaXOwACz6tLdYjcdCF3fVjs0/0",
	"UdisweIT7HPxVF93bYJZoQ3GY7ze6kRB+enW8YivCDNH7TR+Rdj5m319+rWUzuOelBuNR1+NOj6+hXc9",
	"839LJTt4GA9edZe1/tzBc1zVNxI71d9dVMi/qqT6P8jqMdWWNEuzJukwm9UdL13jAVuMru0gFptW5HHe",
	"i3z0G+9K9BR6CznyC3Rp6/w4aGZL1deg1cjYBooa2ARTS3wuHBe7ZNlAR792K4rH5Dpa4CQhbE6ul0Qt",
	"eCyvtXnIhTKp//WlyG2vW1Mp0xDdfTh/8xqZH9Gny5/zq2vjFBYuricdGqr63cX7QkCQOZVKbA5KCFxt",
	"DXTQZXmD/ZRlv8FEiJ67dSkN03adPO/UJDPTYbXNGDvT+ZbpejAdF9+qKfbozm1sKrNmNRtQ9mBK3pBy",
	"e1NqQ6J0PQ32FrN1yd9tpDiBeGm1rw1OErOtH+33k9+eWH6NmW02VahOZBGxZs5BOA8Vzl1YoKFmIOyN",
	"VTEKv6PXnDESqaHmhnOTrml8DQ8HBNrF4GV2FQpkBN+hCAuxdmUl0kTIs3e8aWwSUBRHEReCJNpbSvic",
	"MmmyI9yXydqIUUk5IzF6efX6/P2R6UtT7Nv3j5FMp/8YdYof6+GUzfi20ViEeCeVWkBirUrtgsqOenXv",
	"EOpk9D9GnMb/GMEx3zIl8BjdLbgkaIWpuKOSuBEoprMZETLvn6LXyDZwHg5Pd6GJ4TTQRaUVSKFWpXUh",
	"hUa9Ziboqtf2llzyo7tWdF5XwScoJTpI/DYx0aXtd7uA2CSmmL/HvUlkMdBIPYNeD4ZqY6UWcDUxURZ9",
	"mOw0RJs3Qd4EnIG+61VwtlPf0KbjW47i1aBl0vveaOvRvk12dogKPm5UsIlHGlgj/GpS1yLk8ruCvRop",
	"Pf7DihmgzNLdCp5rX7XqB7Tiu4TttdstDwKWjgKNXLscx92bhy7g3W/VC3jybcUlgYscRSJTrZN120Bc",
	"oFnKItOyg6r1BJ0rZON50r9yh49tC0qTVAcgihQX/kMW8EYVdGUrvvoxdh0r4LrfDI2IDGWLe731hzzC",
	"ZR+nWgkSYfC/jWAqNarJfj9Fv0A3gcITJQbmE/RJFnr9X1OwIWdERYvC93lmvI3MwdWZcDjBqxXBQiJm",
	"VqIMYWZe7ji7OM8C0PYRwxklSZz3mmYxmVFG4gnkWw18HBlnL+rL4tZGrflO205EyPno2n9bsRua81cW",
	"h+E4s0d9BAd2VEB0NuihsBzeUBO2vafist1m7zU14frJpoU0bXrfnj95yqkkTXBeCTKj34J1OwwBkguo",
	"Kl08KNsJDUt4AP4cmenGThGBDkjg3T9pU8UW2LY08maC4WYo0mIMq8UJtI05mQlsepZBejkW0Lk7czG0",
	"zbzgUkErMqhEhc4ziHzDkco4eJkmiq4S4lYQWWqaxIrK2Vo7F95uYOXSsSGCAHUmnM2JVG4uapvdFDIU",
	"/bZMECkOmSL67yiLILvkTA9VwwPKTzZjZpdpLncLwq6NvREsnPvZ5p1nKD1/Y0hy7IoU9VASj9ESf7V5",
	"MTFZERYTFq0RvsUUgG47GbnL5buqjoD/ti2ogLLzafr14u6QuZMtuoPMnVDnbCsuOqXwXFbETtXM7Z/C",
	"43FIrU25U7tpC2pbcYSl5BHVpJ6Jlqejww+qt0ZDQqi3ptXhRhoTVJlVmrKnyixGrWFvp56Sg+4HRi9O",
	"10Y1+hOlLCEyfy0vWbv+mw+o0BpboTTmUWUucX3w1n0yNNqYIfLlCgvgYyPujib/YP9gv/vdZywYZfPT",
	"3/0OvV5gNncXFDf5jm+sKwDOsyD4az47lAyY8LBJlc+UBSXNjvN2hFx9394uNTM7l4UbbO8gMh/9scan",
	"5VpsV6DVU2Ym59qi1l1fhsyEXEPYkCfBkKHgCTHQiTCDwJ33qIx5iydr8+R64z/k0xdbYdIfXr16tfXY",
	"hAZoK6c38ZpGSR5S71L653nsXDsaF7Yu71gPjN2rQF6zjuk6K/yD14izBKslj4204QLFJIGS7VuK4WRn",
	"F+d5dWBlaijz9oruNuvk9+CVDEDvw58PKrg8hfroLv5OgWSKvHkGbLcMPod86cpXtaiCAxQfJctL8gus",
	"+pQfIvNOAWcOagd7qhabIT99NjEtvI3VPHmY2z4uCPpKWQyF6G0LnKIbzRU3Y3TjGVU38Db3DTyvcTNB",
	"ZyHM2V/1fIX35EAgw28vCg/LBZ8Ma7Pz3Ip1EsvOUW+gfFjhMBYLU2fWykp/oFkDwcO9ZZoMr98k+j7k",
	"k4UWnqA3VOLllM5TqL40ssrT+MXoHY4El9LboRzUWkRr/3B3jQVBOfRtfwlnFJRr13MWgDRtZj6fdM4x",
	"7UC+mT1i30/DZq288QVUK6MbjZ6boy1u8JElvbfz4fK+JCdKUinnvyoXVem6s45AZwHBWKcuNn6IC2Yy",
	"4TNjDBZUysRVdbuYOdIA5jN0Yw98A1KudPqbn9BNfvKsY7sGsnHhKgPAPoEI/ZS4kobipzdV07Of0MhO",
	"ByeewLvDDTsaIhU6iOPiLrYrj9vn7iq2cqHBjaSwr6pp4aF4ThSKz02pu4FhLpMAfC3+TX8JFtpMWX41",
	"bo3GRi1rCkNTrhaGB1gm2Tyx0XqC+1q2bYo2Fbi3Rz+cksm0aVOcktH5OO1wSmCr74lT8pWqJjJYZdkH",
	"pwijhN8REWFJkEzSOXqZEKW0OwsxNDqnSmZ3+WBz2W7Hi/VqQRg0n4DuOTLigsijTtbNpDUGUnMx9uvx",
	"9Zfy3ZgPovPGimJ4qLiOkHzykajeOehPPY9IM/WEcnX1waY5h3vMXH1AUfZ7IFkZM8QbHwXrkUEK+W7b",
	"6Czy+Yn2E+n3gFkR9n1zOvToUHWj7bWT15EdDQiPdk7iLJCX39Zid8ZuyEAtNkvISDJETJ2sTg3c1wHU",
	"1PBVr0tZVkX8hiy1tSRrvjL28hhV063pzJFbfPSsaLVCT0FSqiWOBtMmvGBtEURA+lYopaXQoVOJQnBb",
	"pl6hYMOVztlUS9c05QaldD2P/wwLJevR0aPSsQE7G9W4OQOhZEQYkTpBb3G0sPe4cD1Fj6XCioyNs6E4",
	"Sgi+JShl0QKzOYnHSBIWZ9dDUUKwsH/D6BYnqXF4iNrzkrlSiQqcE72c4SSRaIqjrx6FHO2CRBpuxYKU",
	"0la81YsoPmjc45ygMjKgKqeEye4lXaDapEbedQVXz3SJrRoBlbtVU/d0tE3joPsKe2oKtJNEAyXUPgkV",
	"cEFtV0oSF5+DgAi9SXk3j0XYhtRLHpNkDC3OOZNjc3PJmSLfIKC/IvlDErY9aP6exAS9p0JwYSbMG+Fe",
	"vLmwl6IQnjm7OEcvXc81vKJHu3qND1rdmvPWdbu10KjvdnuRvbADUXnbuRamnvTdxPU/ZfDJVH8nWJqu",
	"ua48Iry+ngi9tBlvTXI7J5ohPXTz+o6NEEHldZac1/gCBZVZms0L6Wq3LWTq3tVVqawVgwmdkWgdJSR7",
	"aMM00j417ebKj42ZHAz3frhrdEvVTyj2CllkuiJCkpjEaJoqJJX2XnAUkZWSoXl/yl4AOkVRwq1KD3wY",
	"fEDAK7HJmz1vrQ9613bAZoQN9v746sf/Pn714/GPvz9qdZi9nrgGVQVq6NZr0H9wrqk77kf+lbChdYbQ",
	"5qWpxFCmZqHqfOaHUNAFJq3YYJCK5Cr2XO9dtrZbyJpY+Dl4U2IpzF6Y8FShaEGir7D5/NrbK23XBma3",
	"hzbLxZOwj+a6SQB1t5JJ84tB4qUpW4QH6QrALSUadX0bw9uRWQZZYnELtezniqjaLfVdUiO5+7KWjL3V",
	"Gy8Qu73m897e4Gk8T+BFAJuw5NgYS//9EnjvvviGXVnClh9zrjxDUIWBPVkjLEQylE0/Xf48tIBaD61m",
	"ur50157Y9Dh31mBbp6sy06QiaWYZvXwnhtHGXMiQA3RpcNgQuZ/9nOcJtkXQwxmlr+FeFcV8iSmDhFL0",
	"8vUvZ+/fHmWyzN5bZHBxlV2BW5cHrmd9yFRiG6KknF1/Jes2y/9t9vU7sj67k++W8jW4r71TturSd55q",
	"UWPdfjv0xg55+OFbs26tVjQ/De2EDWOrXbB9mWg3kc34ZZ+aZO8ySyiVUHFg/MrmGoSs9UbWqCoV1smE",
	"RgYQ9RpaOVfsdJ0TYCfj8+8FOi4K6f7VceHE0EcRyXsqNJ9CLxmN+y7dpUtk1HB3ExBRw9rs1gjK+mal",
	"dWsURqBsRLtdVFzKvPJ87RfA1K14VljxCgYiVxGT7QC9nNyRJDmGB4xPQPYeF5Y8Nkt2MeHiSFzbarr6",
	"uMSbNcNLGqHXJj556TUpRVS6arxgcKK29Wp2ZhuALNwC9mmxWpwX4kafyRTa2VzBG3Od0bb6GpHrnILr",
	"oHHx7vXbQj4hEF0BcxGPCZpppzYIFEFiKkikwkfIQeO+g+KirJFGWeL17Y5ct1oTlntAsdortm5B4+t3",
	"njrc4buN28Z1jF/ZaQkvdRD0qK9MMkV2Kou+bn3Hq2Jwo57j4DDVtj2scL8NUIb62GxBGAQYrMOCm/Lb",
	"fSseemmloX23nRGZq6hKuW47fjZCSI2N0oygbWCkbeEOGGoOFWylLXST8ZBZ7sVG0m0L5W9oFBaqUeTg",
	"Ox0XVuiiwoMtWxu39UkScc5mfLDsrQFHaC8VKdg9iyJgY/ZxmJtF31C/OdCnFc7VUZYMvOLvJDu20ZO1",
	"Vt7VH7iZNYf2NOgmIDfzGxuu2Lv4k0+qvn9L/uUDld0P8DLznQ0MqkAOkY2rlMIqg3s4lJmijhfuxyNo",
	"mUvVGgjfUO+UYEGE5rb8X39yhPfXzx9HZZPor58/oj/CZ8jcPp0VOmO6ZzhBucJn+U4WSq1G93ojNJgk",
	"4aq0zy6MqwG5Co4RTc2CWhAq8nD7xKsR8EZ7r4Kejl5NXk1+cKFGvKKj09F/Tl5NXkFuvVoAFE78cBX8",
	"ZU6CNcgqFUwinBUUFMZljO2/zxmXLwK07ID/Po9tw60PhcX1tgReEkWEhDaQVC8N7dZc+OzUBdPypIoK",
	"UYTHRamQXAwZmdAlVYWBmeX8w6tXwH90mS5dn4ElZfaf1Xdf779oVW7fmtIz/fjqFUhS8xBtqYPLicvW",
	"yFfepGjDB3ZN8Qa5dvTZUrthkn0aKjfsTNVY9P19tUenybJwgNHf3I9LlHnyvRRXve9Aq7amxx+Jpmuo",
	"cxMowVOSVKjyz6RAlFWabLiBKM4LpKT5LKekamg4h56RcDmmu2LyPP4gfoYlN6eu7tRTxeLHvClwmfO7",
	"4fME38mTr2R9bC6E29HL0Lv3V9CX2V4hW7ViclOzDhauGcZXspZt6H73/uodWZu75N8W6kseV4aCaoAv",
	"ez3bQt3vHgOZeZShs89XReToeVv9GrNoF5HxN7goz60unwog69qUSHYkPCn5cVSqGktIyG5+QyVYXldX",
	"H/yL8LCCsx8XS9L2nKh+31pTF5tTx0im0DFzliYJqJffm8FbEUZvheAiRBgF+DGu0IynDNrc6G3qP7iI",
	"DAzNUgJ3uyv4wddvuUEKNOCbor9+0WCX6XKJxbpEcsXyOTzXFKThP/pyPw4Lyz8ThVqLHhup+M9EPSsK",
	"3p5GLIIlgPYyZxCFaSIPvDCYF6rUHOCDFVbRIpDrYII4TcxQoX0zZt/JH2yyP/J4vRvKz0JUbfRvw2iO",
	"DcpnvX9CrGpTMQ46bDt8G+S9EOtyGUwD6m5zmW8PHNvIAFkUvY0NytKxjWF/eDSGdSUTVYb9n92zht4L",
	"lQgnguA464+c5wzwUuBlL3jW47oGntXuFcQoe0QOTUxzYMTw77DYIVK400gh5Bw+wQjhZUbJe8JE8KjE",
	"vy3JOs4xJFyv74x4ll7GZgdmmSCbn08hMkYlNzV7hN1SwU1XKj3L+dn74iVCkcXM2jbndBeKyEtbNdGZ",
	"ndl8hoir+BxYx7AvJGeAm6W/l2guk9cn320IvS7UdUHEEuv9JmvbIli622/MYmitTZXMe7PnTS6rUdY3",
	"MN5SVaMxBvd40OUlYHu1mFtlId0perW3osXAtA7P42ZlbH0wrY0xyir2ALlwPxKKAj0++g6yYQvxk1qC",
	"aYybON5/IUvxw0CSSCiG8ijEsxvtlcc7DtprV5GCdu2l/+88vj/xS4/zoso+7oj/EIo3A7LFT/nLHHZT",
	"VZ/Ee3j0tbeFnTop3q7P4/31ctwSRWY3yH1QbbGJuxTE/8F/2pb/VMOgnnzwEIB8DuzqY4VXqHGOwtgO",
	"M/t2yHr7eix4hodxyxqWvvQSgMYVuW1+CxU11qBvzzy2WiJsp/LuenGY28e6cohxSh6UQ8Ia5OAqVl3F",
	"DQhskDsZXq/ewXwOZLNjORmiDA9TpkTBvXGbN3KURNxS7R1Aax9vT3KvXNeNCLjNva2TcWWPt8bB3VPi",
	"fSDT4mF85gPLhHzpndkVA53sgZ71jv3pQgX8wZl+Es70wYXegQtd4zd3d5Z9cXGs7T0+U3dYECTXUpGl",
	"yb7P3lxTXoK4EbPosvaeqOJg77Vb/bAaLxgsZgVsUdmALu8irx1zE3Su4LVqHCmkZ1bwoh6akgVOZujl",
	"EkcLysix4sf2P4/g2aXsC/AUoATwpfYy56bfKaxyNNljz72euVp06RYc83Zv/OCDPyEfvEkOD/C2fUbv",
	"4mIfHOuDzHwCjnyjNdLqsntDKjfT8KJk3oioxWn/jbvqD+6gH1jvKQQENjNXdnj5bnqthELJPW7g/8RF",
	"O4c/b0/+SWjjw93687hb7ywXYrIiLCYsoh0KA7Lnff1R7lmlHoz/xl+0E6/fLQi7zmK/h7jf/ksLp/EP",
	"AmIXAiIucti2JMTJ9+xf6/PmIMgltAjTBkRVaqztVU2z0DAzhMTG+km7AOFJfMAdgi0Z5Rokh2l3PSTu",
	"IigxZJdZpCH60/ZsM/UVQzAH0tu2g5nL/1DmtPvVepbGoQSnkXxbcUkk9CYlETiVzDQh1LTDBZqlLDJv",
	"41C1BnfSHlj6NVnwsXkuw/rrkKQWKS7ca0vaC4W3XsCb1EZOftgxmpIZF8Q8yWSGauNkb4M7HblulYae",
	"ro/jOjmveBufncVxHz7rbhdmVkjNczzO3HhiNtlBe/Qg4rM47k3EnYyevECue4Akr+xwz5Gj6bqnZ+Rf",
	"uB5CIAen5uDUeNztV612Z+654OmqCx+v8JwyCBc7jjZDkfe20iTIwH82S2xSNDeMW8rdnLU0gHjMjIs7",
	"LGJ3JiN5gsVJM9WeR1W7zBRHX7utY8ylfgu9NzIIsXQ5Na+bAQeYBtQaazVrVWVbSGSVO78bm9E8Cw9r",
	"UBYlaUwQZ4jgaGGoYYIuyYpgeH4d3mD9tkp4nLU9Dm2HfFthFv/6JWyd5A9pKpxcRzyFLvNLoo+c/VPw",
	"hMjgQ65lKSPVGhoNa5N4VD3mJdFDI+jg6t78t1QO1zVqQaQmUumfc4yW+Bv64dWrCXqfqhQekSffoiSV",
	"9Na28LwBOro5uTF4vukImhlNFBG/0vjLINOt9bh/gvm1GibfcKTMUb0ndPxT/oSWaaLoKiHmSX+JsCDo",
	"w+WxefW9z2nc9Ds61Wu+XOJjSbS0gU46XChLtxN0IciMfrNYOb4BNtXDCYspm0/QmXZY4Hnh7EGzMbQn",
	"HxefFgpmbHKhRo/lMBohq8Vt2GWsE9/7pe9ylYPLpbVWy3RJ/jOiqiZpD+Z5aGW1o3txOIvfJOvh+l4Z",
	"MNa0V2bkLllnra7m5tM9S5Wz2w4QYK2VdfId/r8lNPwm61Fi5DFOOJsbiUWVREb3yQVdmXb6WvkhLCWd",
	"Q2+cQCscM+Gj0HVFOMMualew4Nm+C6+JzkDzDkubdRjvXcpdPcmN26x3c3hIp5uEgrnPlTp6WrLK0cnO",
	"DNktma47NyXaO+Pvl9iGgK7PBjWmQ1vvGJjhhTSvAWEWn3D/0clJTX7esxa+O7Jb/Ha8D9dgt5H4XTfd",
	"/SJ9ly23kcVyYu2OQZGiTKy+yOyXhlDRe7vSb0AbHWJSu4hJPUgUakfhJssefrwJLlj3Nei0c0PFSove",
	"kQ8H6T0MgGRb7xH9sLfQQEuK1wdBzuLYA+vBZBlAi48YcLFY6xR2yQMJ+3WhXeCBDa2Zk++aITrn6gH3",
	"mOS8Ov4xHz9vFqos8cloqPAKBsK7iekYNEJQxzy6Gu9dat9WyNmEEdpMc0jn0l/aeCGJtSrwYh5WlyLK",
	"FkRQZe0PGNJgr1/yhJzlAciD3X6w2397dns5DP8cLox3muBaFBp9zPcyqPfRgq+coY8pD8Mgp1TP4ovw",
	"nzL/0YlwqgI2PkyQye6DkT+MaB/Hzi/uoZupX6K2/bH3YcseoW8YwwRL5uS7/r9Wm/+WfyUZj4HN7xlK",
	"9kF40/0LLwm6kRFfkWtNhzcn9h80vkErTIUdiJkCQ9UhRQv6MVRnL6lCU67VhVa3emEYkjKYJzZjQ66G",
	"/vQ5s3FV82pk1K1g0LrZAlca4ugrZXEet9aIyzDj4Z7PiVpo7wM0dobzSV16UEYhowFbUljMiRq2KaDK",
	"5m3ReLQVh6wkaaxnpve4T54ZsKDP+v3kjk1wF33S47MxPZoKXmTrPOGOghWCd0a561A5Go++knWERXx8",
	"C8SR/1uq0N34oXfhzjP1HWUdMvW3ZfavPF51MiTn364tC90I06/Qq/uTqT6z/s50jFE8bxrjnrnid9KU",
	"8MHP/gtsNamQGRXsV/NCt+2H6VyYs0rIe80QVqnU7Imxl5+kVg5c+J2F5FEZk3vXcnCV01iILZq068CX",
	"37wVQ3mSuyb6Q4vBrvmOLaQxqLlgxo+1nQX3FP8HgfYUMgxbSbY1v9B9PqQL4P6Q7u6U/sP0/zvwyEap",
	"iP2V/mYV591d6oYK82DtXL7GdN1eIdbdk25fzHuIxoHTi4yVXePsYwfnYW/tdQkhPECl1JOrXw86uEOd",
	"2t9vdKQlkRLPSRA5hU26D4dts7cDHCpPz7mtqwOcdb453qjxjW16A51pCl1vajzhDPPPoy7QHedhPORD",
	"L6Mn4WmLnIZD/NekdAd62h7XhDztx2KqUD6HIcHDe+3dvfMWchrknWeIqPXOf0M0cxDAz6mZXCu7tEYG",
	"3OdDIgPPm212ZyA9TDThwJ9PIioxwEDqmXYdkxllgKZAPGKCPi4ImqVJYvNKkSRKIz1KhTCmlcnFNRNg",
	"JCmbJwSt8Jz8BPOVs0ZPbuBi+waZm3GUsz407xFEEnFLYhAgjCu0JgoRTUERicfw15s829jNYsbi5A6v",
	"JWJpkoQzwy8BNI8tblzgBKC/xQjNrjNjG/Jh/SzYQvO1/boPF5Y+HKcBKRiiqWe1QureAPsSEnrqbcun",
	"kES37Qy3XVNqmEhNvqZ7xWZKCgUnqXQFrlkfpz2z5QyhdCHdaxrfn6x4Qju9IBGqnXeD2/ssXrhlul7/",
	"XNNNy2CwJMeUScIkVfSWIJlOzddIEiyiBeIM3egVb2p6ySkilv1bycE/f9X/2FUPuV3V9wwsotnpfa8l",
	"mz4lGBlF71cOlsdKlf5xGfd0DUXDbGvtiylMGREFBkWvSYwFsgDRVtwSMzwnMXKNCZM1UgvB0/nCzXRL",
	"hKScybrOdLDD9c64e0eulL/3SzP/Q5dMWMB1KpVY2W/3rRtdTpFhmm7SSyffzcjrlijvmYgW1FRCmwFj",
	"FCUcnpunkI2uN+GouFp1ZEbvmIrHoax0y2BV67+4XgaFp5OL00i52EB074jWUkJGRnVSeICFbzFdn911",
	"oL5tUV/eCW7PyM+0gitRStgMaIvJmkm8dnDI/7ImS+tZkuD2DQcfWr0Mh4diANcNbs/IP2sHtw1z4SRT",
	"96ffa6zmi3SaULnI7Ga6XKbgBlobuWj9opTFRPi7qzeF/2aGHFipjw1ugfaoprhDXA+L3NHHflrmOc2X",
	"TlNivjX6m+OnATx48t3+V3dDnjVtrcF+f36s17Sik01tK+fgf2I2XAvDlRyJveO1skPRib1ae2ZnTkUd",
	"i7S5GQcmeU5MUvZ39o5LjN9TdpU30kTrY7vjQVcbBfvPToTwLaYJMJttbFNf/g4Dr+wGHozJzIJIkJUg",
	"kjBlEihM3sUE3UT6UDf2ql6iRbrE7FgQHHsmr1wzhb8hyuzn12b5mzG60XSSj9bnN0P+evXhFwsjZPK0",
	"K8OvYWxdnwezwXCR+wioc5yV5sOso7H5c7gAP3jP7nA4XSM7N5IKq1RO0OcFYehGA/tmnB2PM4iCGxy/",
	"kPkgmMcNmuFEVkYxzo6Ln8sJ+rCkKu9ZhnCSZL/V3ffLaweFABFMOU8IZg/aAe6p3hA5Rut9TZSx9h5e",
	"FuV7r4hHJ3e6SMfMML/vICcDUlEzVJ1ZnlkbZkMPa2zY7TnVbz9uUvsH2buh7N0loxvwWsX/marF3zlz",
	"LTy62UR2nb2q2S3sfCCfE7VBdsca6fH+/fHYvKmYPfpkUwDRlMI7dU6rNplFRB0SQQ6JIAPUPFGDdDxR",
	"e6rgLeuFE0LWCBipQ04IQymb8pTF3sQT9EfKYpQrSMXhpryY9yGJ6pj7cUXUPqd/XBH1qGHnK6K0Uvuj",
	"EaK9os8SIL8g2LV1e/sRz6vU8JYpqtZI4TmIDL5SdEmlohGKODNC3KYMCZ5M0AWW2s6g0rypCk2enRo4",
	"nx2/xypaILOoFqCpdyN2RaAjZD0+7/c4hcWCO8yJLWo4i4xLonontADTNke+d8mDTeE1KAboFtQzJ39i",
	"0bVuzFeORGtC2NsodBMVt0afPbT3NgNzn/BArDsk1qr3c9ASD5K0o8krmLjjm2vdcnf0XDZ/Z9KYsPM8",
	"WamysqZY1/N2JaiHLxuOlUSNTXtqk0cC0ViZRhEhsUTU1BF6e19gCcVlU0IYWvLYFLxJyiLyE+JqQcQd",
	"lQT9/ocf0YUgEWcxhaDOnzBNSIyozKresuiKofX8+I4JRo+cpdTXvn0cqVVMWzrIrAfLtNqmVdsh7+pv",
	"OKFG1mmgLzGjMyLVGOnTp/rPV385M1WeUe7DVq66PecUSYZXcsFVq5P6mBffD2B67NxLfgo5Wh4aezrK",
	"zyxVyz9RiHu7XpQ3cfF2Mre8nU5Af2b6OMvN8KvJIVrV7u0+X2ZuW3nvM1raeTjgb+9/9lcfjt0gC8wn",
	"EfBGmh3xAx89Yz4KhQKeSYJYP26qcbv1dzhS9Jb8QaMTKQ5BLOsiWPrAxlQ138F1TGNYtuR6Hfhrl/y1",
	"c895iM378HxehfoYMX5naXZ/VKbebtk37W7lwlLi1jFYKpLR6ehkdP/l/v8HAAD//w==",
}
