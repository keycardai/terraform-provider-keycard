...
- `when_accessing` (List of String) Optional list of resource identifiers. When specified, the dependency is only active when the application is accessing these specific resources.
